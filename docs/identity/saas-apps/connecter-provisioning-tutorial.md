...
1. In the **Tenant URL** field, input your Connecter Tenant URL and Secret Token. Select **Test Connection** to ensure Microsoft Entra ID can connect to Connecter. If the connection fails, ensure your Connecter account has the required admin permissions and try again.
